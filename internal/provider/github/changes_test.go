...
func TestRegisterPublishesTheChangeContracts(t *testing.T) {
	...
	want := map[string]capability.Risk{
		...
		"github.projectviews.list":       readRisk,
		"github.projectviews.create":     changeRisk(capability.EffectCreate, capability.IdempotencyNonIdempotent),
		"github.projectviews.update":     changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.projectviews.delete":     changeRisk(capability.EffectDelete, capability.IdempotencyUnknown),
		"github.projecttemplates.mark":   changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.projecttemplates.unmark": changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.projectstatus.list":      readRisk,
		"github.projectstatus.create":    changeRisk(capability.EffectCreate, capability.IdempotencyNonIdempotent),
		"github.projectstatus.update":    changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.projectstatus.delete":    changeRisk(capability.EffectDelete, capability.IdempotencyIdempotent),
		"github.projectcollaborators.update": changeRisk(capability.EffectUpdate,
			capability.IdempotencyIdempotent),
		"github.projectteams.list":        readRisk,
		"github.projects.linkteam":        changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.projects.unlinkteam":      changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.projectworkflows.list":    readRisk,
		"github.projectworkflows.delete":  changeRisk(capability.EffectDelete, capability.IdempotencyUnknown),
		...
		"github.pullrequests.create":     changeRisk(capability.EffectCreate, capability.IdempotencyNonIdempotent),
		"github.pullrequests.update":     changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.pullrequests.close":      changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.pullrequests.reopen":     changeRisk(capability.EffectUpdate, capability.IdempotencyIdempotent),
		"github.pullrequestbranches.update": changeRisk(capability.EffectUpdate,
			capability.IdempotencyNonIdempotent),
